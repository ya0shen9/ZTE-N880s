...
TARGET_PREBUILT_RECOVERY_KERNEL := device/zte/n880s/prebuilt/kernel
...
TARGET_BOOTLOADER_BOARD_NAME := n880s

# assert
TARGET_OTA_ASSERT_DEVICE := N880S,N880s,n880s,blade
...
BOARD_EGL_CFG := device/zte/n880s/egl.cfg
...
#BOARD_VENDOR_QCOM_GPS_LOC_API_HARDWARE := n880s
...
#add by Astinj for optimize usb starage
BOARD_CUSTOM_USB_CONTROLLER := ../../device/zte/n880s/UsbController.cpp
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING:= ../../device/zte/n880s/recovery/recovery_ui.c
TARGET_RECOVERY_INITRC := device/zte/n880s/recovery/recovery.rc
